...
class Note():
    ...
    class Theme():
        """class representing the theme of a sticky note"""
    ...
    def __init__(self, text, theme: Theme = None, is_open: bool = False):
    ...
    @staticmethod
    def _calc_creation_ticks(dt: datetime):
    ...
    def set_creation_date(self, dt: datetime):
...
class StickyNotes:
    ...
    def get_window_position_string(self, note: Note):
    ...
    def write_notes(self, *notes: Note):
        if len(notes) >= 4:
            warnings.warn(
